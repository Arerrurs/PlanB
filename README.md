...
## v7
- Шаринг с мобильного пытается отправить картинку-карточку и ссылку на конкретную цитату.
- В админке добавлена сортировка цитат по лайкам и дизлайкам.
- Ускорена начальная загрузка: последняя цитата и список цитат кэшируются в браузере.
- Для моментального входа после регистрации в Supabase нужно выключить Confirm email: Authentication → Sign In / Providers → Email.
